        ...
        if ($response['status'] == "success") {
            ...
            if (isset($response['errors'])) {
                foreach ($response['errors'] as $error):
                    $error_msg .= "<li style='color: red;'>{$error}</li>";
                endforeach;
            }else{
...
if (isset($_POST['edit']) == "edit") {
    ...
    if (isset($_POST['store_id']) && isset($_POST['name']) && isset($_POST['type']) && isset($_POST['description']) && isset($_POST['cost']) && isset($_POST['quantity'])) {
        ...
        $response = $productCtrl->update((int)$product_id, $data);
...
<div>
    <div style="width:800px; margin:0 auto;border: 3px solid #f1f1f1;"><h3><?php include_once "admin_menu.php" ?></h3>
    </div>
        ...
        <div>
            ...
            <div>
                ...
                <input type="text" placeholder="Enter Product Name" name="name"
                       value="<?php echo isset($_GET['name']) ? $_GET['name'] : '' ?>" required><br/>
            ...
            <div>
                ...
                <input type="text" placeholder="Enter Product type" name="type"
                       value="<?php echo isset($_GET['type']) ? $_GET['type'] : '' ?>" required>
                <br> <br>
            </div>
            ...
            <div>
                ...
                <textarea rows="2" cols="50"
                          name="description"><?php echo isset($_GET['description']) ? $_GET['description'] : '' ?></textarea>
                <br> <br>
            </div>
            <div>
                <label><b>Cost</b></label>
                <input type="number" placeholder="Product cost" name="cost"
                       value="<?php echo isset($_GET['cost']) ? $_GET['cost'] : '' ?>" required>
                <br> <br>
            </div>
            <div>
                <label><b>Quantity</b></label>
                <input type="number" placeholder="Product Quantity" name="quantity"
                       value="<?php echo isset($_GET['quantity']) ? $_GET['quantity'] : '' ?>" required>
                <br> <br>
            </div>
    ...
    <table>
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    <a href="record_product.php?<?php echo createUrlParams($product) ?>">
                        <button type="button">Edit</button>
                    </a></td>
                <td>
                    <a href="confirm_delete.php?product_id=<?php echo $product['id'] ?>">
